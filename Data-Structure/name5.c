...
////////////////////////////////////////////////////////////////////////////////
// (과제) Allocates dynamic memory for a name structure, initialize fields(name, sex, freq) and returns its address to caller
...
// (과제) Deletes all data in name structure and recycles memory
void destroyName( void *pName) {

tName* pNode = (tName*)pName;
free(pNode->name);
free(pNode);
